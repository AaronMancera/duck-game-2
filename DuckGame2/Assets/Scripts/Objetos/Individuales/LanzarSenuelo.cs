...
public class LanzarSenuelo : Objeto
{
    ...
    [SerializeField] AudioClip lanzarSenueloSFX;
    ...
    void Lanzar()
    {
        ...
        //Activo señuelo en el AudioManager
        AudioManager.instanceAudioManager.PlaySFX(lanzarSenueloSFX);
