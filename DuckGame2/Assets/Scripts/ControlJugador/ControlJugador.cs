...
public class ControlJugador : MonoBehaviour
{
    ...
    void Fall() // mejoras en la caida
    {
        ...
        else if (rb.velocity.y > 0 && playerControls.Player.Saltar.phase == InputActionPhase.Canceled) // si estamos a�n en subida del salto y ya hemos dejado de pulsar el bot�n, a�adimos multiplicador peque�o
        {
